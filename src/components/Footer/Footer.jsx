...
export default function Footer() {
  ...
  return (
    <>
      <footer className="relative bottom-0 z-50 inset-x-0 dark:bg-gray-700 dark:text-white bg-gray-100">
        <div className="dark:bg-gray-700 bg-gray-500 text-white text-center py-2">
          <p>Copyright © Your Website 2021</p>
        </div>
      </footer>
      <div
        className={`row justify-center fixed inset-x-0 bottom-0 z-40  mb-15 ${isOpen ? "translate-y-0" : "translate-y-[100%]"} transition duration-300 dark:bg-gray-400 bg-white lg:hidden`}
      >
        <div className="flex justify-center dark:bg-gray-800 bg-white w-full pb-4">
          <button
